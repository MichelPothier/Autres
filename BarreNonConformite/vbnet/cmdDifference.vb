...
'
'''<summary>
'''Permet d'identifier les différences entre la Géodatabase SDE et la version de travail.
'''</summary>
'''
'''<remarks>
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            Else
                ...
                vMsgBoxResult = MsgBox("Désirez-vous utiliser l'archive externe ?", MsgBoxStyle.YesNoCancel, "Identifier les différences")
            ...
            'Identifier les différences entre la Géodatabase enfant et son archive dans un TreeView
            m_GererReplica.IdentifierDifferences(m_MenuNonConformite.treDifferences, bExterne)
            'Définir le nombre de différences
            m_NbDifferences = m_GererReplica.NbDifferences
            ...
            m_MenuNonConformite.AfficherInfoDifferences(m_MenuNonConformite.treDifferences.SelectedNode)
