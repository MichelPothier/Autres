...
Public Class clsGererMapLayer
    ...
    '''<summary>Collection des Géodatabases de la Map.</summary>
    Protected gqGeodatabaseCollection As Collection = Nothing
...
#Region "Constructeur"
    ...
    '''<param name="pEsriWorkspaceType"> Contient le type de géodatabases recherchées.</param>
    ''' 
    '''</summary>
    '''
    Public Sub New(ByVal pMap As IMap, Optional ByVal bNonVisible As Boolean = False, _
                   Optional ByVal pEsriGeometryType As esriGeometryType = esriGeometryType.esriGeometryAny, _
                   Optional ByVal pEsriWorkspaceType As esriWorkspaceType = Nothing)
        Try
            'Définir les valeur par défaut
            gpMap = pMap

            'Définir la collection des FeatureLayers
            gqFeatureLayerCollection = DefinirCollectionFeatureLayer(bNonVisible, pEsriGeometryType, pEsriWorkspaceType)

            'Définir la collection des RasterLayer
    ...
    Protected Overrides Sub finalize()
        'Vider la mémoire
        gpMap = Nothing
        gqGeodatabaseCollection = Nothing
...
#Region "Propriétés"
    ...
    '''<summary>
    ''' Propriété qui permet de définir et retourner la collection des Géodatabase de la Map.
    '''</summary>
    ''' 
    Public Property GeodatabaseCollection() As Collection
        Get
            GeodatabaseCollection = gqGeodatabaseCollection
        End Get
        Set(ByVal value As Collection)
            gqGeodatabaseCollection = value
        End Set
    End Property
...
#Region "Routine et fonction publiques"
    ...
    Public Function DefinirCollectionFeatureLayer(ByVal bNonVisible As Boolean, _
                                                  Optional ByVal pEsriGeometryType As esriGeometryType = esriGeometryType.esriGeometryAny, _
                                                  Optional ByVal pEsriWorkspaceType As esriWorkspaceType = Nothing) As Collection
        'Déclarer les variables de travail
        Dim pLayer As ILayer = Nothing                      'Interface contenant un Layer.
        Dim pGroupLayer As IGroupLayer = Nothing            'Interface contenant un Groupe de Layers.
        ...
        Try
            'Définir la collection des Géodatabase vide
            gqGeodatabaseCollection = New Collection
            ...
            For i = 0 To gpMap.LayerCount - 1
                ...
                If pLayer.Visible = True Or bNonVisible = True Then
                    ...
                    If TypeOf pLayer Is IFeatureLayer Then
                        ...
                        If Not pFeatureLayer.FeatureClass Is Nothing Then
                            ...
                            Or pFeatureLayer.FeatureClass.ShapeType = pEsriGeometryType Then
                                ...
                                'Si c'est une Géodatabase recherchée
                                If pEsriWorkspaceType = Nothing Or pDataset.Workspace.Type = pEsriWorkspaceType Then
                                    'Vérifier si la Géodatabase est déjà présente
                                    If Not gqGeodatabaseCollection.Contains(pDataset.Workspace.PathName) Then
                                        'Ajouter une nouvelle Géodatabase
                                        gqGeodatabaseCollection.Add(pDataset.Workspace, pDataset.Workspace.PathName)
                                    End If
                    ...
                    ElseIf TypeOf pLayer Is IGroupLayer Then
                        ...
                        Call DefinirCollectionFeatureLayerGroup(gqFeatureLayerCollection, pGroupLayer, bNonVisible, pEsriGeometryType, pEsriWorkspaceType)
                    End If
                End If
            Next
...
#Region "Routine et fonction privées"
    ...
    '''<param name="pEsriWorkspaceType"> Contient le type de géodatabases recherchées.</param>
    ''' 
    Private Sub DefinirCollectionFeatureLayerGroup(ByRef qFeatureLayerColl As Collection, ByVal pGroupLayer As IGroupLayer, ByVal bNonVisible As Boolean, _
                                                   Optional ByVal pEsriGeometryType As esriGeometryType = esriGeometryType.esriGeometryAny, _
                                                   Optional ByVal pEsriWorkspaceType As esriWorkspaceType = Nothing)
        'Déclarer les variables de travail
        Dim pLayer As ILayer = Nothing                      'Interface contenant un Layer
            ...
            For i = 0 To pCompositeLayer.Count - 1
                ...
                If pLayer.Visible = True Or bNonVisible = True Then
                    ...
                    ElseIf TypeOf pLayer Is IGroupLayer Then
                        ...
                        'Trouver les autres FeatureLayer dans un GroupLayer
                        Call DefinirCollectionFeatureLayerGroup(qFeatureLayerColl, pGroupLayer2, bNonVisible, pEsriGeometryType, pEsriWorkspaceType)
                    End If
                End If
            Next i
