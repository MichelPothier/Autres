...
'**
'Nom de la composante : cmdAnnulerReplica.vb
'
'''<summary>
''' Permet d'annuler le réplica de la Géodatabase Parent et Enfant.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdAnnulerReplica
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            'Annuler le replica de la Géodatabase Parent et Enfant
            m_GererReplica.AnnulerReplica()
    ...
    Protected Overrides Sub OnUpdate()
        If m_GererReplica Is Nothing Then
            Enabled = False
        ElseIf m_GererReplica.GdbParent Is Nothing Then
            Enabled = False
        Else
            Enabled = True
        End If
