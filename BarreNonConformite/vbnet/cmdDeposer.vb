...
'**
'Nom de la composante : cmdDeposer.vb
'
'''<summary>
'''Permet de déposer les différences entre la Géodatabase enfant (.mdb ou .gdb) et son archive interne ou externe dans la Géodatabase parent (.sde).
'''</summary>
'''
'''<remarks>
...
Public Class cmdDeposer
    ...
    Protected Overrides Sub OnClick()
        ...
        Dim bExterne As Boolean = True              'Indiquer on doit vérifier les différences à partir de l'archive externe.
        ...
        Try
            ...
            m_MenuNonConformite.tabMenuNonConformite.SelectTab(m_MenuNonConformite.tabDifferences)
            ...
            Else
                ...
                vMsgBoxResult = MsgBox("Désirez-vous utiliser l'archive externe ?", MsgBoxStyle.YesNoCancel, "Déposer les différences")
            ...
            'Déposer les différences entre la Géodatabase enfant (.mdb ou .gdb) et son archive dans la Géodatabase parent (.sde)
            m_GererReplica.DeposerDifferences(bExterne)

            'Initialiser les réplicas selon la géodatabase enfant
            m_GererReplica.Init()
    ...
    Protected Overrides Sub OnUpdate()
        If m_GererReplica Is Nothing Or m_NbConflits <> 0 Or m_NbDifferences = -1 Then
            Enabled = False
