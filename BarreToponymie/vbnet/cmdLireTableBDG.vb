...
Public Class cmdLireTableBDG
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If m_TableToponymeBDG.Table Is Nothing Then
                'Afficher un message d'erreur
                MsgBox("ERREUR : La table des toponymes BDG est invalide : " & m_TableToponymeBDG.Name)
                Exit Sub
            End If
            ...
            Call CreerListeNomToponymeBDG(pTrackCancel, "GEONAMEDB='CTI_LABEL'")
            ...
            MsgBox("Lire les toponymes de la BDG :" & vbCrLf _
                   & "-Nombre de toponymes BDG : " & m_ListeNomToponymeBDG.Count.ToString & vbCrLf _
    ...
    Protected Overrides Sub OnUpdate()
        ...
        If m_TableToponymeBDG IsNot Nothing Then
            'Vérifier si la table est valide
            If m_TableToponymeBDG.Table IsNot Nothing Then
                'Vérifier si l'attribut NAMEID est présent
                If m_TableToponymeBDG.Table.FindField("NAMEID") >= -1 Then
                    'Rendre active
                    Enabled = True
                End If
            End If
