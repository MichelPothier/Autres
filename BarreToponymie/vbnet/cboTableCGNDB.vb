...
'**
'Nom de la composante : cboTableCGNDB.vb
'
'''<summary>
''' Commande qui permet de définir la table des toponymes de la CGNDB.
'''</summary>
'''
'''<remarks>
...
Public Class cboTableCGNDB
    ...
    Protected Overloads Overrides Sub OnSelChange(ByVal cookie As Integer)
        Try
            ...
            'Définir la table 
            m_TableToponymeCGNDB = m_MapLayer.ExtraireStandaloneTableByName(CStr(Me.GetItem(cookie).Tag))
    ...
    Public Sub RemplirComboBox()
        ...
        Try
            ...
            If m_TableToponymeCGNDB IsNot Nothing Then
                ...
                sNom = m_TableToponymeCGNDB.Name
            End If
            ...
            For i = 0 To pStandaloneTableColl.StandaloneTableCount - 1
                ...
                'Vérifier si la classe contient l'attribut TOPONYMIC_FEATURE_ID
                If pStandaloneTable.Table.FindField("TOPONYMIC_FEATURE_ID") >= 0 Then
