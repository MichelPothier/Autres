...
#********************************************************************************************
"""
Outil qui permet d'afficher les traitements de livraison des données Geobase.

L'information est extraite de la table SER_RECONCILE_LOG du compte SER_GEST_BDG.

Nom: AfficherTraitementLivraisonGeobase.py
...
-------
 Nom                            Description
 -----------------------------  --------------------------------------------------------------------
 AfficherTraitementLivraisonGeobase          Finaliser la livraison des données Geobase.
"""
#********************************************************************************************
__version__ = "--VERSION-- : 1"
__revision__ = "--REVISION-- : $Id: AfficherTraitementLivraisonGeobase.py 1111 2016-06-15 19:51:31Z mpothier $"
#********************************************************************************************

# Importation des modules publics
import os, sys, arcpy, datetime, cx_Oracle, shutil

# Importation des modules privés (Cits)
import  CompteBDG, util_bd

#*******************************************************************************************
class AfficherTraitementLivraisonGeobase(object):
#*******************************************************************************************
    """
    Afficher les traitements de livraison des données Geobase.
    ...
    #-------------------------------------------------------------------------------------
        """
        Initialisation du traitement pour afficher les traitements de livraison des données Geobase.
    ...
    #-------------------------------------------------------------------------------------
        """
        Exécuter le traitement pour afficher les traitements de livraison des données Geobase.
        ...
        ----------
        self.CompteBDG  : Objet utilitaire pour la gestion des connexion à Geobase.       
        oBDG            : Objet utilitaire pour traiter des services Geobase.
        """
        
        #Instanciation de la classe BDG et connexion à la Géobase
        arcpy.AddMessage("- Connexion à la Géobase")
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Définir l'objet pour afficher les traitements de livraison des données Geobase.
        oAfficherTraitementLivraisonGeobase = AfficherTraitementLivraisonGeobase()
        
        # Exécuter le traitement pour afficher les traitements de livraison des données Geobase.
        oAfficherTraitementLivraisonGeobase.executer(env, statut, date)
