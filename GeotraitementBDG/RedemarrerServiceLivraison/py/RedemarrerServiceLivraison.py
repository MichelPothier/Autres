...
"""
Outil qui permet de redémarrer le service de livraison des données.
...
#*******************************************************************************************
    """
    Redémarrer le service de livraison.
    ...
    #-------------------------------------------------------------------------------------
        """
        Initialisation du traitement pour redémarrer le service de livraison.
    ...
    #-------------------------------------------------------------------------------------
        """
        Exécuter le traitement pour redémarrer le service de livraison.
        ...
        arcpy.AddMessage(" ")
        arcpy.AddMessage("- redémarrer le service de livraison des données")
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Définir l'objet pour redémarrer le service de livraison.
