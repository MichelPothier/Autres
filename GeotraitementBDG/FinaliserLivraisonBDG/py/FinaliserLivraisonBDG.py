...
# -*- coding: iso-8859-1 -*-
#********************************************************************************************
"""Outil qui permet de finaliser la livraison des données BDG.
    ...
    2-Les fichiers « *.log » de réservation ne se sont pas effacés.
      Détruire les fichiers « *.log » dans le répertoire de réservation.
      Exemple :
        \\dfscitsh\CITS\Logs\gestion_bdg\Gestion_BDSpatiales\Reservation\pro\bdg\CORINT\099A12\170479

    3- Les fichiers « *.log » d’obtention d’autorisation de livraison ne se sont pas effacés.
      Détruire les fichiers « *.log » dans le répertoire d’obtention d’autorisation de livraison.
      Exemple :
        \\dfscitsh\CITS\Logs\gestion_bdg\Gestion_BDSpatiales\Obtention_autorisation_livraison\pro\bdg\CORINT\099A12\170479

    4-Le fichier de réservation n’a pas été archivé.
      Déplacer le fichier de réservation dans le répertoire d’archive.
      Exemple :
...
-------
 Nom                            Description
 -----------------------------  --------------------------------------------------------------------
 FinaliserLivraisonBDG          Finaliser la livraison des données BDG.
"""
#********************************************************************************************
...
#*******************************************************************************************
    """
    Finaliser la livraison des données BDG.
    ...
    #-------------------------------------------------------------------------------------
        """
        Initialisation du traitement pour finaliser la livraison des données BDG.
    ...
    #-------------------------------------------------------------------------------------
        """
        Exécuter le traitement pour finaliser la livraison des données.
        ...
        for job in listeJob.split(","):
            ...
            #Détruire les fichiers « *.log » dans le répertoire de réservation.
            arcpy.AddMessage(" ")
            arcpy.AddMessage("- Détruire les fichiers *.log dans le répertoire de réservation")
            ...
            #Détruire les fichiers « *.log » dans le répertoire d’obtention d’autorisation de livraison.
            arcpy.AddMessage(" ")
            arcpy.AddMessage("- Détruire les fichiers *.log dans le répertoire d’obtention d’autorisation de livraison")
            ...
            #Déplacer le fichier de réservation dans le répertoire d’archive.
            arcpy.AddMessage(" ")
            arcpy.AddMessage("- Déplacer le fichier de réservation dans le répertoire d’archive")
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Définir l'objet pour finaliser la livraison BDG.
        oFinaliserLivraisonBDG = FinaliserLivraisonBDG()
        
        # Exécuter le traitement pour finaliser la livraison BDG.
