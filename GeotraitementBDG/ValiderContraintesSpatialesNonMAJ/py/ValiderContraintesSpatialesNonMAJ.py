...
""" Outil qui permet de valider les contraintes spatiales des données non mis à jour en fonction d'une classe et une contrainte spatiale et d'une table de statistiques d'erreurs.
    ...
    tableLivraisons     : Nom de la table contenant les livraisons des jeux de données.
...
#*******************************************************************************************
    """ Valider l'intégrité des données spatiales non mis à jour en fonction d'une classe et une contrainte spatiale et d'une table de statistiques d'erreurs.
    """
    ...
    #-------------------------------------------------------------------------------------
        """
        Exécuter le traitement pour valider l'intégrité des données spatiales non mis à jour en fonction d'une classe et une contrainte spatiale et d'une table de statistiques d'erreurs.
        ...
        #----------------------------------------------------------
        arcpy.AddMessage(" ")
        arcpy.AddMessage("- Extraction des identifiants de la table des statistiques d'erreurs non mis à jour")
...
if __name__ == '__main__':
    ...
    try:
        ...
        #Définir l'objet pour valider l'intégrité des données spatiales non mis à jour dans la BDG selon une table de contraintes spatiales.
        ...
        #Exécuter le traitement pour valider l'intégrité des données spatiales non mis à jour dans la BDG selon une table de contraintes spatiales.
