...
"""
    Application qui permet de modifier l'information relative aux listes de codes d'élément topographique pour toutes les normes de la BDG.
    ...
    Exemple:
        ModifierListeEntiteProduction.py SIB_PRO "FORTMCMURRAY" "Liste des codes pour la mise à jour du secteur Fort McMurray" "List of codes for update FortMcMurray sector" "1:Oui" 10000001;10000002
"""
...
#*******************************************************************************************
    """
    Classe qui permet de modifier l'information relative aux listes de codes d'élément topographique
    ...
    #-------------------------------------------------------------------------------------
        """
        Exécuter le traitement pour modifier une liste de codes d'élément topographique (entité de production) pour toutes les normes de la BDG
        ...
        #---------------------------------------------------------------------
        #Modifier l'information de la liste des codes d'élément topographique
        arcpy.AddMessage(" ")
        arcpy.AddMessage("- Modifier l'information de la liste des codes d'élément topographique ...")
        ...
        #Définir la commande pour modifier l'information de la liste
        ...
        arcpy.AddMessage(" ")
        arcpy.AddMessage("- Modifier la liste des codes d'élément topographique ...")
        ...
        for code in listeCodes.split(","):
            ...
            #Définir la commande pour modifier le code d'élément topographique à la liste
...
if __name__ == '__main__':
    ...
    try:
        ...
        #Définir l'objet pour modifier une liste de codes d'élément topographique (entité de production) pour toutes les normes de la BDG.
