...
####################################################################################################################################
# Nom       : ModifierEntiteNormeProduction.py
# Auteur    : Michel Pothier
# Date      : 08 août 2016

"""
    Application qui permet de modifier l'information relative aux codes d'élément topographique (entité de production) pour un numéro de normes de la BDG.
    ...
    Usage:
        ModifierEntiteNormeProduction.py env normes altimetrie patrimoine listeCodeElem

    Exemple:
        ModifierEntiteNormeProduction.py SIB_PRO 4.2.2 0 0 "1000000;10000001"
"""

__version__ = "--VERSION-- : 1"
__revision__ = "--REVISION-- : $Id: ModifierEntiteNormeProduction.py 2083 2016-08-08 20:59:38Z mpothier $"
...
#*******************************************************************************************
class ModifierEntiteNormeProduction:
#*******************************************************************************************
    """
    ...
    #-------------------------------------------------------------------------------------
        ...
        #Extraire les codes d'éléments topographiques existants
        sql = "SELECT CD_ELEM_TOPO FROM F132_EN WHERE NORMES='" + normes + "' AND (ALTIMETRIE<>" + altimetrie + " OR PATRIMOINE<>" + patrimoine + ")"
        ...
        #---------------------------------------------------------------------
        #Modifier l'information relative au code d'élément topographique
        arcpy.AddMessage(" ")
        arcpy.AddMessage("- Modifier l'information relative au code d'élément topographique")
        ...
        for codeDesc in listeCodeElem.split(","):
            ...
            sql = "SELECT * FROM F132_EN WHERE CD_ELEM_TOPO='" + codeElem + "' AND NORMES='" + normes + "'"
            resultat = self.Sib.requeteSib(sql)
            ...
            if codeElem in listeCodeExistant:
                ...
                sql = "UPDATE F132_EN SET UPDT_FLD=P0G03_UTL.PU_HORODATEUR, ETAMPE='" + sUsagerSib + "', DT_M=SYSDATE, ALTIMETRIE=" + altimetrie + ", PATRIMOINE=" + patrimoine + " WHERE CD_ELEM_TOPO='" + codeElem + "' AND NORMES='" + normes + "'"
            ...
            #Si le code est inexistant
                ...
                #Afficher l'ancienne valeur
                arcpy.AddWarning("ATTENTION : Aucune modification car l'information correspond déjà !")
...
if __name__ == '__main__':
    ...
    try:
        ...
        #Définir l'objet pour modifier l'information relative aux codes d'élément topographique (entité de production) pour un numéro de normes de la BDG.
        oModifierEntiteNormeProduction = ModifierEntiteNormeProduction()
        
        #Valider les paramètres obligatoires
        oModifierEntiteNormeProduction.validerParamObligatoire(env, normes, altimetrie, patrimoine, listeCodeElem)
        
        #Exécuter le traitement pour modifier l'information relative aux codes d'élément topographique (entité de production) pour un numéro de normes de la BDG.
        oModifierEntiteNormeProduction.executer(env, normes, altimetrie, patrimoine, listeCodeElem)
