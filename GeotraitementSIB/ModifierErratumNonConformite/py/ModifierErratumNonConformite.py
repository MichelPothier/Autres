...
#####################################################################################################################################
# Nom : ModifierErratumNonConformite.py
# Auteur    : Michel Pothier
# Date      : 6 janvier 2015

"""
    Application qui permet de modifier un Erratum pour un numéro de non-conformité dans SIB.
    ...
    Usage:
        ModifierErratumNonConformite.py env no_nc desc_fr desc_an

    Exemple:
        ModifierErratumNonConformite.py SIB_PRO 03645 'Description en français de l'erratum' 'Description en anglais de l'erratum'

"""

__version__ = "--VERSION-- : 1"
__revision__ = "--REVISION-- : $Id: ModifierErratumNonConformite.py 2057 2016-06-15 21:03:15Z mpothier $"
...
#*******************************************************************************************
class ModifierErratumNonConformite(object):
#*******************************************************************************************
    """
    Permet de modifier un erratum pour un numéro de non-conformité dans SIB.
    """
    ...
    #-------------------------------------------------------------------------------------
        """
        Initialisation du traitement de modification d'un erratum pour un numéro de non-conformité dans SIB.
    ...
    #-------------------------------------------------------------------------------------
        """
        Exécuter le traitement de modification d'un erratum pour un numéro de non-conformité dans SIB.
        ...
        if len(resultat) == 0:
            #Retourner une exception
            raise Exception("Le erratum est absent")
        ...
        #Modifier le erratum du numéro de non-conformité
        arcpy.AddMessage("- Modifier le erratum pour le numéro de non-conformité")
        sql = "UPDATE F702_ER SET ETAMPE='" + sUsagerSib + "',DT_M=SYSDATE,UPDT_FLD=P0G03_UTL.PU_HORODATEUR,DESCR='" + desc_fr.replace("'", "''") + "',DESCR_AN='" + desc_an.replace("'", "''") + "' WHERE NO_NC='" + no_nc + "'"
        arcpy.AddMessage(sql)
...
if __name__ == '__main__':
    ...
    try:
        ...
        #Définir l'objet de modification d'un erratum pour un numéro de non-conformité dans SIB.
        oModifierErratumNonConformite = ModifierErratumNonConformite()
        
        #Valider les paramètres obligatoires
        oModifierErratumNonConformite.validerParamObligatoire(env,no_nc,desc_fr,desc_an)
        
        #Exécuter le traitement de modification d'un erratum pour un numéro de non-conformité dans SIB.
        oModifierErratumNonConformite.executer(env,no_nc,desc_fr,desc_an)   
