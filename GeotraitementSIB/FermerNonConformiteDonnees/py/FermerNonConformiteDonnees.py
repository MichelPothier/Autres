...
#####################################################################################################################################
# Nom       : FermerNonConformiteDonnees.py
# Auteur    : Michel Pothier
# Date      : 15 juillet 2016

"""
Outil qui permet de fermer une non-conformité sur les données géographique après avoir
...
-------
 Nom                            Description
 -----------------------------  --------------------------------------------------------------------
 FermerNonConformiteDonnees     Fermer une non-conformité sur les données géographique.
"""
#********************************************************************************************
__version__ = "--VERSION-- : 1"
__revision__ = "--REVISION-- : $Id: FermerNonConformiteDonnees.py 2158 2018-07-12 21:17:59Z mpothier $"
#********************************************************************************************
...
#*******************************************************************************************
class FermerNonConformiteDonnees(object):
#*******************************************************************************************
