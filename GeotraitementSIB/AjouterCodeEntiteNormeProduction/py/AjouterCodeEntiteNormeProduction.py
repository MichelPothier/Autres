...
"""
    Application qui permet d'ajouter des codes d'élément topographique pour un numéro de normes de la BDG.
...
#*******************************************************************************************
    """
    Classe qui permet d'ajouter des codes d'élément topographique pour un numéro de normes de la BDG.
    """
    ...
    #-------------------------------------------------------------------------------------
        """
        Exécuter le traitement pour ajouter des codes d'élément topographique pour un numéro de normes de la BDG.
        ...
        for codeDesc in listeCodeElem.split(","):
            ...
            #---------------------------------------------------------------------
            #Ajouter l'information relative au code d'élément topographique
            arcpy.AddMessage(" ")
            arcpy.AddMessage("- Ajouter l'information relative au code d'élément topographique : " + codeElem)
...
if __name__ == '__main__':
    ...
    try:
        ...
        #Définir l'objet pour ajouter des codes d'élément topographique pour un numéro de normes de la BDG.
